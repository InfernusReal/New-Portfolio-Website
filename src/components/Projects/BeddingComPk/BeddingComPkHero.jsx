			...
			<div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
				...
				>
					<div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-br from-emerald-400 to-blue-500 rounded-2xl mb-6">
						<span className="text-3xl font-bungee font-bold text-white">B</span>
					</div>
				</motion.div>
				...
				>
					Enterprise E-commerce Platform with Advanced Admin Management
				</motion.p>
				...
				>
					{[
						...
						<span
							key={index}
							className="px-4 py-2 bg-gray-900/50 border border-gray-700 rounded-full text-sm font-inter text-gray-300 hover:border-emerald-500/50 transition-colors duration-300"
						>
							{tag}
						</span>
					))}
...
export default BeddingComPkHero;
